                    ...
                    <c:forEach items="${cart.cartDetailSet}" var="cd" varStatus="it">
                        <tr>
                            ...
                            <td>  <fmt:formatNumber type="number" minFractionDigits = "2" maxFractionDigits = "2"
                                                    value="${cd.price.nettoPrice}" />
                            </td>
                            <td><fmt:formatNumber type="number" minFractionDigits = "2" maxFractionDigits = "2"
                                                  value="${cd.price.grossPrice}" /></td>
                            <fmt:formatNumber var="totalNettoPrice" type="number" minFractionDigits = "2" maxFractionDigits = "2" value="${cd.price.nettoPrice.multiply(cd.amount)}" />
